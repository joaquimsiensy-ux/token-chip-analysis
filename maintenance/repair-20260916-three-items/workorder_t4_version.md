# 工单 T4（v2.2，r1 订正 T1 小节取成员文案；r2 非阻断措辞采纳；v2 融合 codex 复核 `t4_review_reply.txt`：查询命令语法、`main` 改动限定、副本件数 78、run_all 全绿条件、porcelain/--exit-code 验收）：版本落地 7.1.1 —— repair-20260916-three-items 收官（分支 `fix/three-items-20260916`，已合并 origin/main=7b820a4「7.1.0 W3」）
