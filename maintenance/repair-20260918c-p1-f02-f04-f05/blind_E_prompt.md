...
3. 工作目录＝本仓库根；审对象＝`git diff 0f6f4e47a65f HEAD`（版本登记 commit）。

## 任务
a) 四处版本一致：`VERSION`、`pyproject.toml:15`、`SKILL.md:23`、CHANGELOG 最新索引行与最新详细段标题均为 `9.0.0`；diff 只含这四个文件；`SKILL.md` 8021 B 不变；`references/`、`scripts/`、`commands-staging/` 零差异。
