# 工单 E（v1）：版本落地 9.0.1 —— repair-20260918d-p1-f01-f04 收官（F04 EVM 显式散户桶硬拒 / F01 价格非有限值 fail-closed＋收口逐点重算）
