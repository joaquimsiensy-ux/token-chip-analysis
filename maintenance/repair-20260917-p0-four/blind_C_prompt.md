...
## 范围
- 审查对象：`git diff 8dea1ab..1b317b3 -- scripts/ references/`（施工 commit 范围，由调度方填入）；工单 `maintenance/repair-20260917-p0-four/workorder_C.md`（v3）；施工报告 `C_done.md` 与 `C_red_evidence.txt`；工单复核记录 `review_C_reply_r1..r3.md`。
