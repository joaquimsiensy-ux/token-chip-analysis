# 工单 A 复核提示词（只读，r4：对 v4 复核；r3 唯一退回项 A-R3-01 见 `review_A_reply_r3.md`，重点核用例 13 的基线描述与 `SystemExit`/`OSError` 双捕获取证是否成立；其余项 r3 已判闭合，只需确认 v4 未引入新问题）
...
## 任务
复核 `maintenance/repair-20260917-p0-four/workorder_A.md`（v4；r1/r2/r3 意见见 `review_A_reply_r1..r3.md`）。工作目录＝本仓库根。逐项核：
