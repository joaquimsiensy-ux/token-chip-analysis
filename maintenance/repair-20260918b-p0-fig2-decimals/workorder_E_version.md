# 工单 E（v1）：版本落地 8.0.0 —— repair-20260918b-p0-fig2-decimals 收官（G1 图 2 必画下限 / G2 EVM decimals 链上观测 bundle v2）
