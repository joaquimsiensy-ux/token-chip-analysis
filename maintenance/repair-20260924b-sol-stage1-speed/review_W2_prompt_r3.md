...
首行固定 `# 工单W2复核r3：通过` 或 `# 工单W2复核r3：退回`。
## 任务
复核 `maintenance/repair-20260924b-sol-stage1-speed/workorder_W2.md`（**v3**，已吸收你 r2 意见 `review_W2_reply_r2.md`；背景 `README.md`、`fable_probes_20260924.md`）。重点对照 `review_W2_reply_r2.md` 6 条逐一核吸收（含 `workorder_WR.md` v2 §0.6-0.8 与 README 顺序段）；§2.4 三段原文请再 `wc -c` 复算；§2.1 退出码优先级与轻校验补充是否定形。
