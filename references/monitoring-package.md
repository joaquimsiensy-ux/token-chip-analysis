...
```json
{
  ...
  "camp_share_series": {
    ...
    "series": {
      ...
      "离场庄": [0.0, 0.0], "狙击集团": [0.0, 0.0], "刷量地址": [0.0, 0.0],
      "流动性池": [0.0, 0.0], "其他大户": [0.0, 0.0],
      "散户": [0.0, 0.0], "锁仓/销毁": [0.0, 0.0]
    }
  },
...
- camp_share_series：固定为 `{"dates":[...],"series":{"阵营名":[...]}}` 对象，禁止使用逐日对象列表；每个阵营数组长度必须与 dates 完全相同。阵营键用 v2.0 标签体系名（缺的阵营省略）。这是 `figures_from_facts.py fig1` 的直接输入契约。
