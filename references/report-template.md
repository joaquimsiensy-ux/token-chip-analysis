...
10. **外部代币名自查**：全文除标的与生态 gas 币外无其他代币名（铁律 1；**仅有的两类受控例外＝用户点名对比项＋惯犯案源案名**，后者的引用边界见 labels/README serial-actor 纪律条）——build_html 已自动扫（3.18.0）：`--token-whitelist "标的符号,用户点名对比项,惯犯命中案名"` 传白名单，$cashtag 命中即 WARN 拒交付，全大写词 [NOTE] 人工扫一眼确认即可
