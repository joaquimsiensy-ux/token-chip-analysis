...
- **6.15.0** 2026-08-04 第四轮全库审计 10 项修复＋round4b 两项同族残留返工：identity 锚定采集实物链，shared release 强制当前生产者/runner，SUITE 46→50 项
...
- 测试：原 10 项与 round4b 两项的最小反例、同族变体与失败分支先红后绿；round4b 新增 1 个 suite 入口，合计 50 项全绿。成本：修复 2 轮；质量：第四轮 10/10＋验收同族残留 2/2 关闭，未新增分析结论，漏检实体/传播级数字错误不适用。
