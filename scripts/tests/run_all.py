...
SUITE = ['changelog_lint.py', ['docs_lint.py', '--all'], 'labels_manifest.py',
         ...
         'test_observation_history_reuse.py',
         'test_solana_observation_reuse.py',
         ...
         'test_sqd_merge_equiv.py', 'test_sqd_merge_streaming.py', 'test_spl_edge_core.py',
         ...
         'test_a4_gate.py', 'test_a4_binding_repair.py', 'test_time_spotcheck.py', 'test_peaks_daily.py',
...
SUITE += [
    ...
    'test_sqd_recheck_checkpoint.py',
